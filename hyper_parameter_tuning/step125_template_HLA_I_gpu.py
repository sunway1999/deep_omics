...
from _st125_build_model_general_u import get_model
...
def pred_asso(enc_method, n_fold, lr, V_cdrs = 2, \
    ...
    checkpoint_path = \
      './step125_HLA_I_saved_models/step125_HLA_I_best_valid_' + \
      setting_name + '.hdf5'
    ...
    df_metric.to_csv("./step125_HLA_I_metrics/step125_HLA_I_metrics_" + \
