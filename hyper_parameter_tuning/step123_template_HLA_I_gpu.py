...
from _st123_build_model_general_u import get_model
...
def pred_asso(enc_method, n_fold, lr, V_cdrs = 2, \
    ...
    checkpoint_path = \
      './step123_HLA_I_saved_models/step123_HLA_I_best_valid_' + \
      setting_name + '.hdf5'
    ...
    df_metric.to_csv("./step123_HLA_I_metrics/step123_HLA_I_metrics_" + \
