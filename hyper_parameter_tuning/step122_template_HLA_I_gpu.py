...
from _st119_get_acc_classes_loss import get_acc_classes
# this file constructs and encodes the data
from _st120_bpad_general_I import get_data
# this file builds the model
# file _st81_build_model_general works for both HLA-I and HLA-II
# no need to change
...
def pred_asso(enc_method, n_fold, lr, V_cdrs = 2, \
    ...
    #save_path = \
    #  './step120_HLA_I_saved_models/step120_HLA_I_last_saved_' + \
    #  setting_name + '.hdf5'
    ...
    # the following setting comes from
    # https://software.intel.com/content/www/us/en/develop/articles/
    # tips-to-improve-performance-for-popular-deep-learning-
    # frameworks-on-multi-core-cpus.html
    # comment them out for running on GPU machine
